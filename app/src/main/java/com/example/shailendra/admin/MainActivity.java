...
import com.example.shailendra.admin.userprofile.RegisterActivity;
...
import static com.example.shailendra.admin.StaticValues.MAIN_FRAGMENT;
import static com.example.shailendra.admin.StaticValues.MEMBER_LIST_FRAGMENT;
import static com.example.shailendra.admin.StaticValues.ORDER_LIST_FRAGMENT;
...
import static com.example.shailendra.admin.StaticValues.cityNameList;
...
import static com.example.shailendra.admin.database.DBquery.homeCategoryIconList;
...
//        }
    ...
    private void sampleQuery() {
        ...
        firebaseFirestore.collection( "USER" ).document( "SJFiZ7YOlSYqNQ8EMj4ycECsjeh1" ).get().addOnCompleteListener( new OnCompleteListener <DocumentSnapshot>() {
            @Override
